        ...
        if ($accessToken === admin::getAccessToken() && !APP_DEMO) {
            ...
            switch($act) {
                ...
                case "delete": {
                    ...
                    $reports->remove_all(ITEM_TYPE_PROFILE);
                    unset($reports);
                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <?php
                                ...
                                $result = $reports->get(ITEM_TYPE_PROFILE, 50);
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <a href="/admin/reports_profile.php/?act=delete&access_token=<?php echo admin::getAccessToken(); ?>">
...
<?php
    ...
    function draw($dbo, $user)
    {
        ...
        <tr>
            ...
            <td><?php echo "<a href=\"/admin/profile.php/?id={$user['abuseToItemId']}\">To profile Id ({$user['abuseToItemId']})</a>"; ?></td>
            <td>
                <?php

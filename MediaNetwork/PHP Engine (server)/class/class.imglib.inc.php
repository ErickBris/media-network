...
class imglib extends db_connect
{
    ...
    public function createCover($imgFilename, $addon)
    {
        ...
        if ($result['error'] === false) {
            ...
            if ($response['error'] === false) {
                ...
                $result['coverUrl'] = $response['fileUrl'];
    ...
    public function createPhoto($imgFilename)
    {
        ...
        if ($result['error'] === false) {
            ...
            if ($response['error'] === false) {
                ...
                $result['photoUrl'] = $response['fileUrl'];
            }
    ...
    public function createImage($imgFilename)
    {
        $result = array("error" => true);
        ...
        if ($result['error'] === false) {
            ...
            $response = $cdn->uploadImage("../../".TEMP_PATH.$imgNormal);
            ...
            $response = $cdn->uploadImage("../../".TEMP_PATH.$imgPreview);

...
public class SettingsFragment extends PreferenceFragment implements Constants {
    ...
    private Preference logoutPreference, itemContactUs, aboutPreference, changePassword, itemServices, itemTerms, itemThanks, itemBlackList, itemNotifications, itemPrivacy, itemDeactivateAccount;
